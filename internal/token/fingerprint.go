...
// to a token without leaking secret material.
//
// The package contains no concrete OS-keychain code in M1.7 slice T2.1; that
// arrives in later slices behind 99designs/keyring.
package token
